...
extern "C" {
    JNIEXPORT void JNICALL Java_gles_cookbook_helloworldtriangle_GLESNativeLib_init(JNIEnv * env, jclass type, jstring FilePath);
    JNIEXPORT void JNICALL Java_gles_cookbook_helloworldtriangle_GLESNativeLib_resize(JNIEnv * env, jclass type, jint width, jint height);
    JNIEXPORT void JNICALL Java_gles_cookbook_helloworldtriangle_GLESNativeLib_step(JNIEnv * env, jclass type);
};
